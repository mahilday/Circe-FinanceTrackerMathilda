...
function onClick(){
    let newUl = document.querySelector("#event");
    let newBars = document.querySelector("#bars");
    let newTimes = document.querySelector("#times");
    let winDow = window.matchMedia("(max-width:700px)");
   if( newUl.style.display==="none"){
       newUl.style.display = "flex";
       newTimes.style.display="block";
       newBars.style.display="none";

   } else{
       newUl.style.display = "none";
       newTimes.style.display="none";
       newBars.style.display="block";
